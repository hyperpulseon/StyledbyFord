          ...
          <div className="space-y-10 relative">
            ...
            <FadeIn delay={0.2} className="space-y-8">
              <div className="space-y-4">
                <h3 className="text-xl font-serif italic text-gray-300">01. The Vibe Check</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-serif italic text-gray-300">02. The Edit</h3>
                <p className="text-gray-400 font-light leading-relaxed">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-serif italic text-gray-300">03. The Elevation</h3>
                <p className="text-gray-400 font-light leading-relaxed">
