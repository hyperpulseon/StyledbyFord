...
const services = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1558769132-cb1f164e3275?q=80&w=2070&auto=format&fit=crop"
  },
  {
    id: "3",
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <Accordion type="single" collapsible value={value} onValueChange={setValue}>
          {services.map((service, index) => (
            ...
            >
              <AccordionTrigger className="w-full py-8 flex flex-col md:flex-row justify-between items-start md:items-center text-left group hover:no-underline">
                <div className="flex-1">
                  <span className="text-xs text-neutral-500 tracking-[0.2em] mb-2 block">0{index + 1}</span>
                  <h3 className={`text-2xl md:text-4xl uppercase transition-all duration-300 ${value === service.id ? 'font-bold text-black dark:text-white' : 'font-light text-neutral-500 dark:text-neutral-400 group-hover:text-black dark:group-hover:text-white'}`}>
                    {service.title}
                  </h3>
